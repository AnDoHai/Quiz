(function(window) {
  ...
  var WORKER_FILE = {
      wav: "Assets/js/webAudioRecord/WebAudioRecorderWav.js",
      ogg: "Assets/js/webAudioRecord/WebAudioRecorderOgg.js",
      mp3: "Assets/js/webAudioRecord/WebAudioRecorderMp3.js"
  };
  ...
  var CONFIGS = {
    ...
    options: {
      ...
      mp3: {
        mimeType: "audio/mpeg",
        bitRate: 64            // (CBR only): bit rate = [64 .. 320]
      }
    }
  };
